...
export const styles = css`
  ...
  table.stats.bp3-html-table-condensed tr > td:nth-child(2) { max-width: 0; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
  table.stats.bp3-html-table-condensed tr > td:nth-child(3) { max-width: 0; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
  .opener { color:#bfccd6 }
